<?php
class ControllerCommoniplProduct extends Controller {
	private $error = array();
...
//print_r($product_id);
		...
		if ($product_info) {			
			...
			$results = $this->model_commonipl_product->getProductImages($this->request->get['product_id']);
			...
			if (isset($product_info['special'])&&$this->config->get('config_tax')) {
				$data['tax'] = $this->currency->format((float)$product_info['special'] ? $product_info['special'] : $product_info['price'], $this->session->data['currency']);
			} else {
				$data['tax'] = false;
			}

			$discounts = $this->model_commonipl_product->getProductDiscounts($this->request->get['product_id']);
			...
			foreach ($this->model_commonipl_product->getProductOptions($this->request->get['product_id']) as $option) {
