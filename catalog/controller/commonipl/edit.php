<?php
class ControllercommoniplEdit extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_shopify_user->updateUser($this->customer->getId(), $this->request->post);
		...
		$data['back'] = $this->url->link('shopify/account', '', true);
