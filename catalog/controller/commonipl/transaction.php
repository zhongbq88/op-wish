...
class ControllerCommoniplTransaction extends Controller {
	public function index() {
		...
		$this->load->language('shopify/transaction');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('shopify/transaction', '', true)
		);

		$this->load->model('shopify/transaction');
		...
		$pagination->limit = 10;
		$pagination->url = $this->url->link('shopify/transaction', 'page={page}', true);
		...
		$data['continue'] = $this->url->link('shopify/dashboard', '', true);
