<?php
class ControllerStoreLogin extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->session->data['shop'] = 'store.customdr.com';
		...
		$data['action'] = $this->url->link('store/login', '', true);
		$data['register'] = $this->url->link('store/login/register', '', true);
		$data['forgotten'] = $this->url->link('store/forgotten', '', true);
		$data['footer'] = $this->load->controller('common/footer');
		$data['header'] = $this->load->controller('common/header');
		//print_r($data);
		$this->response->setOutput($this->load->view('store/login', $data));
	}
	...
	public function register() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateRegister()) {
			$customer_id = $this->model_account_customer->addCustomer($this->request->post,'store');
			...
			$this->session->data['shop'] = 'store.customdr.com';
			$this->session->data['store'] = 'store';
			$this->response->redirect($this->url->link('commonipl/dashboard'));
		}
