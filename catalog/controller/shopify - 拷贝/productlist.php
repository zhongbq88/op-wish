...
class ControllerShopifyProductlist extends Controller {
	public function index() {
		...
		if (isset($reqPath )) {
			...
			$path = '';
			//$parts = explode('_', (string)'20');
			//echo $parts ;
			//echo $reqPath ;
			$parts = explode('_', (string)$reqPath);
			//echo $parts ;
		...
		if ($category_info) {
			...
			return $this->load->view('shopify/product_list', $data);
		} else {
			$url = '';
