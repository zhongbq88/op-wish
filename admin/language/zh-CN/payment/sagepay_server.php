...
// Text
$_['text_payment']					= '支付管理';
$_['text_success']					= '成功: 您已修改了 SagePay 帐户的详细信息 ！';
$_['text_edit']                     = '编辑 SagePay Server';
...
$_['text_rebate_ok']				= '退税已成功';
$_['text_rebate_ok_order']			= '退税已成功，订单状态更新已退税';
$_['text_void_ok']					= '已成功取消订单，订单状态更新为无效';
$_['text_payment_info']				= '支付信息';
$_['text_release_status']			= '款项已发还';
$_['text_void_status']				= '付款已无效';
...
$_['entry_card']					= '存储卡';
$_['entry_cron_job_token']			= '秘密标记';
$_['entry_cron_job_url']			= '例行性工作 URL:';
$_['entry_last_cron_job_run']		= '最后一个例行性工作运行的时间:';
...
// Error
$_['error_permission']				= '警告: 您没有权限修改 SagePay ！';
$_['error_vendor']					= '必须输入供应商 ID ！';