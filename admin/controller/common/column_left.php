...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/customerproduct')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_customerproduct'),
					'href'     => $this->url->link('catalog/customerproduct', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'sale/production')) {
				$sale[] = array(
					'name'	   => $this->language->get('text_in_production'),
					'href'     => $this->url->link('sale/production', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
